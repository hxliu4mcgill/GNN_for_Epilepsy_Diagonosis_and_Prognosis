...
def parse():
    ...
    parser.add_argument('-n', '--exp_name', type=str, default='xy_stagin_experiment_seed02300')

    parser.add_argument('--dataset', type=str, default='xiangya', choices=['xiangya', 'zhengda', 'xyzd', 'loso'])
    ...
    parser.add_argument('--laterality', type=bool, default=False)
    parser.add_argument('--outcome', type=bool, default=True)

    argv = parser.parse_args()
    argv.targetdir = os.path.join(argv.targetdir, argv.exp_name)
    if argv.dataset == 'loso':
        argv.k_fold = 2
...
#     parser.add_argument('-n', '--exp_name', type=str, default='xy_stagin_experiment_seed00')
#     parser.add_argument('-k', '--k_fold', type=int, default=5)
...
#     parser.add_argument('--val', type=bool, default=False)
#
#     parser.add_argument('--laterality', type=bool, default=True)
#
#     argv = parser.parse_args()
#     argv.targetdir = os.path.join(argv.targetdir, argv.exp_name)
#     os.makedirs(argv.targetdir, exist_ok=True)
